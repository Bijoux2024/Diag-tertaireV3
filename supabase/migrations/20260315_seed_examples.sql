...
begin
  ...
  select coalesce((user_workspace_state.ui_state->>'examples_seeded')::boolean, false)
  into already_seeded
  from public.user_workspace_state
  where user_workspace_state.user_id = actor_user_id
    and user_workspace_state.organization_id = target_organization_id
  limit 1;
